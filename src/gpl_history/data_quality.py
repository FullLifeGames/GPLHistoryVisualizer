...
GENERATED_ARTIFACTS = [
    ...
    (Path("normalized") / "streaks.csv", "data/normalized/streaks.csv"),
    (Path("normalized") / "records_progression.csv", "data/normalized/records_progression.csv"),
    (Path("normalized") / "awards.csv", "data/normalized/awards.csv"),
