...
- **Die Season Story erzählt aus Daten, nicht aus Prosa.** Alle Sätze sind i18n-Templates über `matches.csv`, die rekonstruierte Tabellenhistorie (gleiche Regeln wie die Zeitreise), `match_highlights.csv` und `title_odds.csv`; der „rechnerisch entschieden"-Beat ist als Simulation gebadged, und jeder Beat zitiert seine Quellzeilen. Der Einstieg liegt auf der Saisonakte; die Zeitreise verlinkt nicht (sie hat keine gewählte Saison).
