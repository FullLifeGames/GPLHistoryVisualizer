...
- **Die Typen-Matrix zählt Fähigkeits-Immunitäten konservativ:** Nur wenn ALLE möglichen Fähigkeiten einer Spezies die Immunität gewähren (Rotom-Formen mit Schwebe), zählt sie als immun; sonst markiert „+n" eine mögliche Immunität. Halbierende Fähigkeiten (Hitzeschutz, Speckschicht) bleiben unberücksichtigt, ebenso die tatsächlich gespielten Sets.
- **Der „Hypothetische Ausgang" ist eine Simulation**, kein historisches Ergebnis: Elo-Stände beider Trainer am Ende der jeweils gewählten Saison (nicht heutige Werte), umgerechnet per Logistik-Formel; gebadged und gestrichelt abgesetzt.
