...
- **Die „Hypothetische 6er-Aufstellung" ist ein berechneter Vorschlag**, gegen den konkreten Gegner-Kader aufgestellt (sehr effektive Treffer drüben, Standhalten gegen gegnerische STABs, Deckung eigener Schwächen, Typ-Vielfalt; Basiswerte nur als Tiebreak). Cross-Era-Paare bewerten beide Richtungen unter den Regeln der eigenen Generation.
