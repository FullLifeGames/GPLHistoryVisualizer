...
assert.equal(viewGroupForView("team-rosters"), "seasons");
...
assert.deepEqual(subviewsForGroup("people"), ["all-time", "matchup"]);
assert.deepEqual(subviewsForGroup("pokemon"), ["killlists", "pokemon-drafts"]);
assert.deepEqual(subviewsForGroup("seasons"), ["season-detail", "table-history", "match-plan", "battle-history", "team-rosters", "video-archive"]);
