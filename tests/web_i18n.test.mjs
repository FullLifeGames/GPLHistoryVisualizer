...
assert.equal(t("de", "nav.zeitstrahl"), "Zeitstrahl");
assert.equal(t("en", "nav.zeitstrahl"), "Timeline");
assert.equal(t("de", "sections.zeitstrahlTitle"), "Zeitstrahl");
assert.match(t("de", "sections.zeitstrahlDescription"), /Upload/);
assert.equal(t("de", "zeitstrahl.todayTitle"), "Heute vor X Jahren");
assert.match(t("de", "zeitstrahl.yearsAgo"), /\{years\}/);
