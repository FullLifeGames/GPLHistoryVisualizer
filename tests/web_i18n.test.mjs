...
assert.doesNotMatch(t("de", "rosters.rosterFormulaNote"), /TierstÃ¤rke|Score-Komponente/);
...
assert.doesNotMatch(t("en", "rosters.rosterFormulaNote"), /tier strength|score component/i);
...
assert.match(t("de", "columnHints.rating"), /Bayes Rating/);
assert.match(t("de", "columnHints.rating"), /Beta\(6,6\)/);
assert.match(t("en", "columnHints.rating"), /Bayes rating/);
