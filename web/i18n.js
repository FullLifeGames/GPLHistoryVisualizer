...
export const TRANSLATIONS = {
  de: {
    ...
    rosters: {
      ...
      rosterFormula: "Score = 30% Power + 40% Performance + 15% Balance + 10% Historie + 5% Confidence",
      rosterFormulaNote: "Power kommt aus NatDex-Tiers; History aus Drafts und Titeln; Confidence sinkt bei fehlenden Tier-, Einsatz- oder Todesdaten.",
  ...
  en: {
    ...
    rosters: {
      ...
      rosterFormula: "Score = 30% Power + 40% Performance + 15% Balance + 10% History + 5% Confidence",
      rosterFormulaNote: "Power comes from NatDex tiers; History comes from drafts and titles; Confidence drops when tier, appearance, or death data is missing.",
